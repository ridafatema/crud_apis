...
from .views import TasksList, TaskDetail, TaskUser, UserList, TaskViewSet, UserViewSet, UserTaskViewSet, UserSimple, \
    UserSimpleDetail

router = routers.DefaultRouter()
router.register(r'tasks', TaskViewSet)
# router.register(r'users', UserViewSet, basename='users')
router.register(r'users', UserSimpleDetail, basename='users')
...
urlpatterns = [
    ...
    path('user', UserSimple.as_view()),  # to test simple serializers
]
